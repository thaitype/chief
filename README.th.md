...
> คุณกำลังอ่านเอกสาร v2 ซึ่งรองรับ coding agent หลายตัว หากคุณติดตั้ง v1 อยู่ ให้ทำตาม[คำแนะนำการอัปเกรด](#การอัปเกรด)ด้านล่าง หรือดู[เอกสาร v1](https://github.com/thaitype/chief/tree/release/v1)
...
- v1 เป็นเวอร์ชันแรก เน้นรองรับ Claude Code ดู[เอกสาร](https://github.com/thaitype/chief/tree/release/v1)สำหรับรายละเอียด
